...
//   protoc               v5.28.3
// source: omni/v1beta5/types/swap.proto
...
function createBaseSwapRoute(): SwapRoute {
  return { steps: [], gasBudget: "", extraDataJson: "" };
}
...
export const SwapRoute = {
  fromJSON(object: any): SwapRoute {
    return {
      ...
      gasBudget: isSet(object.gas_budget)
        ...
        : "",
      extraDataJson: isSet(object.extra_data_json)
        ? globalThis.String(object.extra_data_json)
        : "",
    };
  },
  ...
  toJSON(message: SwapRoute): unknown {
    ...
    if (message.extraDataJson !== undefined) {
      obj.extra_data_json = message.extraDataJson;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SwapRoute>, I>>(
    ...
    message.extraDataJson = object.extraDataJson ?? "";
    return message;
  },
};
...
function createBaseSwapChunk(): SwapChunk {
  return { protocol: "", offerAmount: "", askAmount: "", extraDataJson: "" };
}
