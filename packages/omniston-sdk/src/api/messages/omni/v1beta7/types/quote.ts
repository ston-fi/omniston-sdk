...
export interface RequestSettlementParams {
   ...
   *
   * Allows inclusion of protocols that have limited support for referral fees.
   */
...
export const RequestSettlementParams: MessageFns<RequestSettlementParams> = {
...
export const EscrowSettlementParams: MessageFns<EscrowSettlementParams> = {
...
export const HtlcSettlementParams: MessageFns<HtlcSettlementParams> = {
...
export const QuoteRequest_AmountOneOf: MessageFns<QuoteRequest_AmountOneOf> = {
...
export const Quote_ParamsOneOf: MessageFns<Quote_ParamsOneOf> = {
